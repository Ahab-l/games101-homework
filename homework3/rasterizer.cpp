    ...
    for(int x=xmin;x<=xmax;x++){
        for(int y=ymin;y<=ymax;y++){
            if(insideTriangle(x+0.5,y+0.5,t.v)){
                ...
                float w_reciprocal = 1.0/(alpha / view_pos[0][2] + beta / view_pos[1][2] + gamma / view_pos[2][2]);
                float Z = alpha * v[0].z() / view_pos[0][2] + beta * v[1].z() / view_pos[1][2] + gamma * v[2].z() /view_pos[2][2];
                float zp= w_reciprocal*Z;
                alpha=alpha * w_reciprocal/ view_pos[0][2];
                beta=beta* w_reciprocal/ view_pos[1][2];
                gamma=gamma* w_reciprocal/ view_pos[2][2];
